...
export default function ProjectCategoryAdd({
  ...
  return (
    <div className="min-h-[41px] self-stretch flex flex-row flex-wrap items-center justify-center gap-[9.8px] min-w-[67%] max-w-full">
      ...
      <button
        className=" max-w-full mq450:w-full flex-shrink-0 h-[41px] px-4 border-[1px] border border-dark-white bg-white dark:bg-dark-steelblue dark:text-dark-black shadow-0px-1px-2px-rgba(0,0,0,0.05) rounded cursor-pointer flex items-center justify-center"
